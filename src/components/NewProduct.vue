      ...
      <div class="col-md-11 card">
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" v-model="product.title" class="form-control" placeholder="ürünün adını giriniz">
          </div>
          <div class="row">
            <div class="form-group col-md-6">
              <label>Ürün Adeti</label>
              <input type="text" v-model="product.count" class="form-control" placeholder="ürünün adetini giriniz">
            </div>
            <div class="form-group col-md-6">
              <label>Ürün Fiyatı</label>
              <input type="text" v-model="product.price" class="form-control" placeholder="ürünün fiyatını giriniz">
            </div>
          </div>
